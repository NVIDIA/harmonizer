...
def main():
    ...
    parser.add_argument("--input", type=str, help="Path to test dataset directory", default="test_dataset/")
    parser.add_argument("--output", type=str, help="Output directory", default="evaluation/")
    ...
    sceneIds = [d for d in os.listdir(testDatasetPath) if os.path.isdir(os.path.join(testDatasetPath, d))]
    sceneIds.sort()
    ...
    for sceneIdx, sceneId in enumerate(sceneIds):
        ...
        # Find camera folders
        cameraFolders = [d for d in os.listdir(renderPath) if os.path.isdir(os.path.join(renderPath, d))]
        ...
        for cameraFolder in cameraFolders:
            ...
            renderImgPaths = (
                glob(os.path.join(renderCameraPath, "*.png"))
