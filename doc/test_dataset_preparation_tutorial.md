# Harmonizer Test Dataset Preparation Tutorial

This tutorial explains how to prepare test datasets for evaluating the Harmonizer model. The test dataset is used to quantitatively measure model performance using metrics like PSNR and LPIPS.
...
- **`render/`**: Contains the degraded/rendered images that will be fed to the Harmonizer model as input
...
2. Apply the Harmonizer model to all rendered images
